...
const mainCourseMenu = [
  ...
  "Spaghetti alla Vongole full portion", // item41
];
...
const packageMenu = {
  ...
  dinner: {
    ...
    mainCourse: {
      ...
      lunch_0: [item19, item20, item21, item22, item23, item24],
      lunch_1: [item41, item26, item27, item28, item29, item20],
      lunch_2: [item18, item30, item31, item32, item33, item34, item35],
      lunch_3: [item34, item37, item38, item40, item39, item29],
      itemHiglighter: [
        "Unlimited Soft Drinks",
        "Unlimited Soft Drinks",
        "Unlimited Soft Drinks",
...
barMenu = {
  title: [
    ...
    " Full Open Bar",
    "Consumptions Bar (billed per drink) - Bartender Fee",
    "Cash Bar (individuals pay at the bar) - Bartender Fee",
  ],
...
dessertMenuItems = {
  menu: ["Dessert", "No Dessert", "Bring Your Own Cake"],
  menuOptions: [
    [
...
message = [
  ...
  "For more information or to book your event, please contact Katie at <a href='mailto:Katie@PinevilleTavern.com'>Katie@PinevilleTavern.com</a>",
];
